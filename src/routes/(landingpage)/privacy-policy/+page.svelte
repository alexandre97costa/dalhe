...
<ul>
	...
	<li>
		<p>
			...
			or &quot;Our&quot; in this Privacy Policy) refers to Dá-lhe!.
		</p>
	</li>
	<li>
		<p>
	...
	<li>
		<p>
			<strong>Website</strong> refers to Dá-lhe!, accessible from
			<a href="https://dalhe.pt/" rel="external nofollow noopener" target="_blank"
				>https://dalhe.pt/</a
			>.
		</p>
	</li>
...
<ul>
	...
	<li>
		<strong>With Your consent</strong>: We may disclose Your Personal Data for any other purpose
		with Your consent.
	</li>
</ul>
...
<p>
	...
	periods (&quot;up to&quot;) and We may delete or anonymize data sooner when it is no longer needed
	for the relevant purpose. We apply different retention periods to different categories of Personal
...
<ul>
	<li>
		Legal obligation: We are required by law to retain specific data (e.g., financial records for
		tax authorities).
	</li>
...
<ul>
	...
	<li>
		...
		consistent with our backup retention schedule and are not restored except where necessary for
		security, disaster recovery, or legal compliance.
	</li>
	<li>
		Anonymization: In some cases, We convert Personal Data into anonymous statistical data that
		cannot be linked back to You. This anonymized data may be retained indefinitely for research and
		analytics.
	</li>
</ul>
...
<p>
	...
	aware that We have collected Personal Data from anyone under the age of 16 without verification of
...
<ul>
	<li>By email: alexandre97costa@gmail.com</li>
</ul>
