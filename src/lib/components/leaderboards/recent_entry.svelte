		...
		class={cn(
			...
			laptime.is_track_record
				...
				: laptime.is_personal_best
					? 'from-yellow-500/15 border-yellow-500/10'
					: 'from-card'
		)}
	>
		...
		<div class="flex flex-col gap-0.5 justify-end self-end text-right">
			{#if laptime.is_track_record}
			...
			{/if}
			<h1 class="lh-1 text-xl font-mono font-medium text-shadow-md text-foreground-100/80 tracking-widest">
